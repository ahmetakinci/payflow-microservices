...
## Proje Özeti
Metasis (Yapı Kredi iştiraki) teknik mülakatına hazırlık amacıyla geliştirilen Spring Boot mikroservis ödeme sistemi.
...
## Öğrenme Tercihleri (ÖNEMLİ)
- Öğreterek ilerle, salt kod üretme
- Mülakat tarzı sorular sor, cevap bekle, sonra devam et
- İskelet ver, Ahmet doldursun (manuel yazma pratiği yapıyor)
...
## Mülakat Odağı
Core Java, Spring, SOLID, Design Patterns, Clean Code, SQL, Mikroservis, React (backend ağırlıklı).
